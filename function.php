...
function tambah_data_pegawai() {
    ...
    echo "      </select><br>\n";
    echo "      Status:<br><select name=\"status\"><option value=\"0\" selected\">Pilih status </option>\n";
...
function ubah_data_pegawai() {
    ...
    if(file_exists("photo/{$sql['photo']}")){
        ...
        $photo = "<img src=\"".URL."/foto/noname.jpg\" class=\"photo\">";
    }
    echo "              {$photo}\n";
    echo "          </div>\n";
...
function tampilkan_pegawai() {
    ...
    if( itung_jumlahnya( $sql ) == 0 ) {
        ...
        while( $row = uraikan( $sql ) ) {
            ...
            echo "  <td><a href=\"".URL."/?option=edit-pegawai&kode={$row['kode']}\" title=\"Klik untuk mengubah data pegawai\"> <img src='foto/ubah.jpg'><a href=\"".URL."/?option=delete-pegawai&kode={$row['kode']}\" onclick=\"return hapus('".$row['kode']."')\" title=\"Klik 
            untuk menghapus data pegawai\"> <img src='foto/hapus.jpg'></a></td>";
